...
public:
    ...
    ///
    /// \brief RDataStream - from raw data
    /// \param d    - byte array
    /// \param l    - array size
    ///
    ...
    ///
    int rewind(void) {
        return seek(2*sizeof(ru32), SEEK_SET);
    }
