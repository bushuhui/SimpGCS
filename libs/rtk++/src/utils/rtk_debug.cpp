                         ...
                         const char *format, fmt::ArgList args)
{
    switch(level) {
    case 1:
        fmt::print_colored(fmt::RED,     "ERR  (FILE={}, LINE={}, FUNC={}}): ", fname, line, func);
        break;
    case 2:
        fmt::print_colored(fmt::BLUE,    "WARN (FILE={}, LINE={}, FUNC={}}): ", fname, line, func);
        break;
    case 3:
        fmt::print_colored(fmt::MAGENTA, "INFO (FILE={}, LINE={}, FUNC={}}): ", fname, line, func);
        break;
    case 4:
        fmt::print_colored(fmt::CYAN,    "{} >> ", func);
        break;
    }
