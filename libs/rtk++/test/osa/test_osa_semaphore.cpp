...
RTK_TestModule_t *g_pTM_osa_Semaphore = &g_oTestModule;

extern int osa_test_semaphore1(void);
...
{
	test_db("********************************************************\n");
    test_db("	Test OSA Semaphore\n");
	test_db("********************************************************\n");
	test_db("1. osa_test_semaphore1(), Basic functionality test\n");
	test_db("CLKEY0: Exit\n");
    test_db("\n");
