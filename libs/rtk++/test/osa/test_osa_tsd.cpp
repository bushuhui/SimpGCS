...
RTK_TestModule_t	*g_pTM_osa_TSD = &g_oTestModule;

extern int osa_test_tsd1(void);
extern int osa_test_tsd2(void);
...
static ri32	test_print(void)
{
	...
	test_db("********************************************************\n");
	test_db("1. osa_test_tsd1(), 32bit TSD data getting/setting test\n");
	test_db("2. osa_test_tsd2(), Interference preventing test\n");
	test_db("CLKEY0: Exit\n");
    test_db("\n");
