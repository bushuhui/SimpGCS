...
RTK_TestModule_t	*g_pTM_osa_Mutex = &g_oTestModule;

extern int osa_test_mutex1(void);
...
{
	test_db("********************************************************\n");
    test_db("	Test OSA Thread Specific Data\n");
	test_db("********************************************************\n");
	test_db("1. osa_test_mutex1(), basic functionality test\n");
	test_db("2. osa_test_mutex2(), Twice unlocking test\n");
	test_db("3. osa_test_mutex3(), Mutex time out and error returning test\n");
	test_db("4. osa_test_mutex4(), Memory leak checking test\n");
	test_db("5. osa_test_mutex5(), Deleted mutex ID calling test(NOT MANDATORY)\n");
	test_db("CLKEY0: Exit\n");
    test_db("\n");
